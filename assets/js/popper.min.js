...
!(function (e, t) {
  ...
  function W(e, t) {
    ...
    var p = o.altBoundary,
      c = void 0 !== p && p;
    (o = M(
      "number" != typeof (o = void 0 === (o = o.padding) ? 0 : o) ? o : k(o, _)
    )),
      (p = e.rects.popper),
      (a = D(
    ...
    if (u) {
      ...
      x === t(o) &&
        ...
        ("top" !== i && (("left" !== i && "right" !== i) || "end" !== a)) ||
          ((b = "bottom"),
          (h -=
            (e && w.visualViewport ? w.visualViewport.height : x[O]) -
            r.height),
          (h *= l ? 1 : -1)),
        ("left" !== i && (("top" !== i && "bottom" !== i) || "end" !== a)) ||
          ((g = "right"),
          (d -=
            (e && w.visualViewport ? w.visualViewport.width : x[j]) - r.width),
          (d *= l ? 1 : -1));
    }
    return (
        ...
        if (((s = {x: 0, y: 0}), o)) {
          if (r) {
            ...
            (w = B[w]),
              ...
              (k = V(0, N(h[j], k[j]))),
              (M = l
                ? h[j] / 2 - P - k - w - v.mainAxis
                : M - k - w - v.mainAxis),
              (l = l
                ? -h[j] / 2 + P + k + O + v.mainAxis
                : c + k + O + v.mainAxis),
